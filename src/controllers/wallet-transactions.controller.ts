...
export class WalletTransactionsController {
    ...
    constructor(private readonly wallettransactionService: WalletsTransactionsService) { }
    ...
    @Put(':id')
    update(@Body() updateWalletTransactionDto, @Param('id') id): Promise<WalletsInterface> {
